            ...
            <div className="flex flex-col">
               ...
               <div className="ml-4 mt-14 flex flex-col space-y-3 sm:ml-8 md:ml-0 md:w-1/2">
                  ...
                  <div className="flex flex-col items-baseline">
                     <a target="_blank" href="mailto:lirkmal171@gmai.com" className="bg-gmail my-2 flex items-center space-x-2 rounded-lg px-3 py-2 text-center text-xs text-white">
                     ...
                     <a target="_blank" href="https://github.com/khmalz" className="bg-github my-2 flex items-center space-x-2 rounded-lg px-3 py-2 text-center text-xs text-white">
                        <svg className="h-4 w-4" fill="currentColor" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                           <title>GitHub</title>
                     ...
                     <a target="_blank" href="https://www.instagram.com/smoizymal_" className="bg-instagram my-2 flex items-center space-x-2 rounded-lg px-3 py-2 text-center text-xs text-white">
                        <svg className="h-4 w-4" fill="currentColor" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <button className="bg-linkedin my-2 flex items-center space-x-2 rounded-lg px-3 py-2 text-center text-xs text-white">
                        <svg className="h-4 w-4" fill="currentColor" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
